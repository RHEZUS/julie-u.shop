  ...
  <div class="">
    <div class="flex justify-between flex-wrap items-start">
      ...
      <div class="modal-groups">
        ...
        <Button @click="showCreateModal()" type="submit" text="Create Location"  btnClass="btn-primary h-10 flex items-center"/>
      </div>
    </div>
    <div>
      <Card noborder>
  ...
  export default {
    ...
    methods: {
        ...
        async deleteItem(itemId) {
          ...
          .then((response) => {
              this.FetchData();
              this.toast.success('Location has been deleted successfully', { timeout: 2000 });
          }).catch((error) => {
              this.toast.error('Failed to delete Location', { timeout: 2000 });
          });
        },
    },
    mounted() {
