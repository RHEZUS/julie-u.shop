<template>
    ...
    >
      ...
      <div class="relative">
        <select
          :name="name"
          :class="`${classInput} input-control-light block w-full focus:outline-none min-h-[40px] `"
          :value="modelValue"
...
props: {
  ...
  .dark {
    select {
      @apply bg-[url('https://api.iconify.design/heroicons/chevron-down-solid.svg?color=black')];
    }
  }
</style>
