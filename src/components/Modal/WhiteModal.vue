        ...
        <div class="fixed inset-0 overflow-y-auto">
          ...
          >
            ...
            >
              ...
              >
                <div
                  class="relative overflow-hidden py-2 px-5 text-slate-600 flex justify-between border-b"
                  :class="themeClass"
                >
                  <h2
                    v-if="title"
                    class="capitalize leading-6 tracking-wider font-medium text-base text-slate-600"
                  >
                    {{ title }}
                  </h2>
        ...
        <div class="fixed inset-0 overflow-y-auto">
          ...
          >
            ...
            >
              ...
              >
                <div
                  class="relative overflow-hidden py-4 px-5 text-slate-600 flex justify-between"
                  :class="themeClass"
                >
                  <h2
                    v-if="title"
                ...
                <div
                  class="px-4 py-3 flex justify-end space-x-3 border-t border-slate-100"
                  v-if="$slots.footer"
                >
                  <slot name="footer"></slot>
                </div>
